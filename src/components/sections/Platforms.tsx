...
export const Platforms = () => {
  return (
    <section className='p-4 bg-white border border-gray-200 rounded-xl flex flex-col gap-5 lg:h-fit lg:col-span-5 lg:col-start-8 dark:bg-black dark:border-gray-500 shadow-sm'>
