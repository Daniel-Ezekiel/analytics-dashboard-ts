...
export const Trend = () => {
  ...
  return (
    <section className='max-h-[30rem] overflow-x-auto flex flex-wrap justify-between items-start gap-4 p-3 bg-white border border-gray-200 rounded-xl md:col-span-full lg:col-span-7 dark:bg-black dark:text-white'>
